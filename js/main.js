$(function () {
    ...
    function e() {
        $("#main_2").addClass("show"), $("#main_2 .clk").removeClass("noclk")
    }

    function t() {
        $("#main_2").removeClass("show")
    }

    function l() {
        $("#main_3").addClass("show"), $("#main_3 .clk").removeClass("noclk"), $(".p3_count").addClass("on"), A.play(), setTimeout(function () {
    ...
    function i() {
        $("#main_3").removeClass("show"), $(".p3car").removeClass("play" + x), $(".p3car").removeClass("done"), x || (x = 1), $(".p3_key").removeClass("deng" + M[x - 1])
    }

    function c() {
        U = 1, $("#main_4").addClass("show"), $("#main_4 .clk").removeClass("noclk"), A.play(), setTimeout(function () {
            v(), b = 1
        }, 5200)
    }
